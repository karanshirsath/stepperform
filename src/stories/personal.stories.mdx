...
<Preview>
  <Story name="Valid">{{
    component: PersonalComponent,
    props:{
      plnch: text('LNCH','1234567890','General'),
      pfirstname: text('First Name','James','General'),
      plastname: text('Last Name','Nicole','General'),
      psurname: text('Surname','Turner','General'),
      pfirstnameeng: text('First Name (ENG)','James','General'),
      plastnameeng: text('Last Name (ENG)','Nicole','General'),
      psurnameeng: text('Surname (ENG)','Turner','General'),
      pcitizen: select('Citizen',{Indian: "Indian",
                                American:"American",
                                African: "African"},'Indian','General'),
      pdob: date('DOB', new Date('Jan 20 1996'), 'General'),
    },
    }}    
  </Story>
</Preview>
...
<Preview>
  <Story name="Invalid">{{
    component: PersonalComponent,
    props:{
      plnch: text('LNCH','12345678','General'),
      pfirstname: text('First Name','James','General'),
      plastname: text('Last Name','Nicole','General'),
      psurname: text('Surname','Turner','General'),
      pfirstnameeng: text('First Name (ENG)','James','General'),
