...
<Preview>
  <Story name="Invalid Credentials">{{
    component: InsuringPartyComponent,
    props:{
      egnLnch: text('EGN/EIK/LNCH','123456'),
      pAddress: select('Address',{'--SELECT--': '','Sofia': 'Sofia', 'Varna': 'Varna','Burgas': 'Burgas'},'Sofia'),
      emailId: text('Email','xyz@g')
    },
    }}    
  </Story>
</Preview>
...
<Preview>
  <Story name="Valid Credentials">{{
    component: InsuringPartyComponent,
    props:{
      egnLnch: text('EGN/EIK/LNCH','1234567890'),
      pAddress: select('Address',{'--SELECT--': '','Sofia': 'Sofia', 'Varna': 'Varna','Burgas': 'Burgas'},'Sofia'),
      emailId: text('Email','xyz@gmail.com')
    },
    }}    
  </Story>
</Preview>
