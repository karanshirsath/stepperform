...
<Preview>
  <Story name="Submit">{{
    component: PolicyDetailsComponent,
    props:{
      policyDateSelected: date('Policy Date',new Date()),
      policyLengthEntered: select('Policy Length',{'1 Month': 1, '3 Months': 3, '6 Months': 6, '12 Months': 12},3)
    },
    }}    
  </Story>
</Preview>
...
<Preview>
  <Story name="Invalid">{{
    ...
    props:{
      policyDateSelected: date('Policy Date',new Date()),
      policyLengthEntered: select('Policy Length',{'--SELECT--': 0,'1 Month': 1, '3 Months': 3, '6 Months': 6, '12 Months': 12},0)
    },
    }}    
  </Story>
</Preview>
